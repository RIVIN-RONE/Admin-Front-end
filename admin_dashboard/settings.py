...
SECRET_KEY = 'django-insecure-15gz-bjc@g)!*ry#dc62r7yse#d#=@@anras(y@jm0=eh$5yd_'
...
INSTALLED_APPS = [
    ...
    'dashboard',  # Your app must be included here
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [],  # Leave this empty to use app-based templates
